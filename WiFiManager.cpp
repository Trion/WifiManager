/**************************************************************
   ...
   Built by AlexT https://github.com/tzapuq
...
void WiFiManager::deviceinfo(char const *_uid, char const *_did){
...
void WiFiManager::handleWifiSave() {
  ...
  page.replace("{v}",_ssid);
  page.replace("{s}","Credentials Saved");
  page += FPSTR(HTTP_END);
...
/** Handle the info page */ //<<<<<----- you want to change this line
void WiFiManager::handleInfo() {
  ...
  page += F("<thead><tr><th>Name</th><th>Value</th></tr></thead><tbody><tr><td>Device Name</td><td>");
  page += _apName;
  page += F("</td></tr>");
  ...
  page += F("</td></tr>");
  page += F("<tr><td>User MAC</td><td>");
  page += uid_;
  page += F("</td></tr>");
  page += F("<tr><td>Device MAC</td><td>");
  page += did_;
  page += F("</td></tr>");
  page += F("</tbody></table>");
...
/** Handle the reset page */ //<<<<<----- you want to change this line
...
boolean WiFiManager::captivePortal() {
  if (!isIp(server->hostHeader()) ) {
    DEBUG_WM(F("Request redirected to wifi configuration"));
